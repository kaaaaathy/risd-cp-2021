...
[ {
  ...
  content:`
  As a class, we are going to create a google doc of rewritten computer history materials.
  <br><br>
...

{
    ...
    <br><br>
    <b>To consider:</b> How do computational ingredients affect the nature of the text? How does the literal and metaphorical concepts randomness, repetition, score transform the text’s meaning? How might randomness become a metaphor for uncertainty, or statistical chaos, or things defying statistical reason? (e.g. Lillian Yvonne Bertram)
    `
	},
	{
		shown:false,
